/* @ts-self-types="./terradeck_wasm.d.ts" */
...
export class CanvasApplication {
     ...
     */
    on_keydown(_e) {
        wasm.canvasapplication_on_keydown(this.__wbg_ptr, _e);
    }
    /**
     * @param {MouseEvent} e
     */
     ...
     */
    on_mousemove(_e) {
        wasm.canvasapplication_on_mousemove(this.__wbg_ptr, _e);
    }
    /**
     * @param {MouseEvent} _e
     */
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('terradeck_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
